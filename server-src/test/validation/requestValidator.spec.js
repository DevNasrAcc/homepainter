    ...
    describe('RequestValidator Test', function () {
        ...
        const _classroom = {
            teacher: {
                name: 'Ms. Frizzle',
                age: 28,
                qualities: ['energetic', 'charismatic', 'magical'],
                details: {
                    email: 'valerie.frizzel@example.com',
                    uuid: 'bc470d8e-3d78-43eb-92f7-8511c9db996c',
                    hiredDate: '1994-9-10',
                    phone: '+1 515-678-9123',
                },
            },
            students: [
                {
            ...
            zip: 50321,
            courseWebPage: 'https://en.wikipedia.org/wiki/The_Magic_School_Bus_(TV_series)',
        };
        const _classroomValidationRules = {
            ...
            zip: {
                type: 'postalCode',
                required: ['obj', 'return obj.teacher.name === "Ms. Frizzle"'],
            },
            courseWebPage: 'url',
        };
        ...
        describe('RequestValidator Module Test', () => {
            ...
            it('Should correctly return failures', () => {
                classroom.teacher.name = 'Valerie Frizzle';
                classroom.teacher.qualities.push(5);
                classroom.teacher.details.email = 'frizzle';
                classroom.students[0].gender = 'Attack Helecopter';

                const failures = requestValidator.Validate(classroom, classroomValidationRules);

                failures.should.deep.equal([
                    "[teacher.name] failed validation: string 'Valerie Frizzle' does not match regex [/^Ms. |^Mrs. /]",
                    '[teacher.qualities[3]] failed validation: expected string, but found type [number]',
                    '[teacher.details.email] failed validation: string "frizzle" is not in valid email format',
                    '[students[0].gender] failed validation: string "Attack Helecopter" is not a valid enumerated value from [boy,girl,other]',
                ]);
            });
        });
        ...
        describe('Validate Test', () => {
            ...
            it('should successfully validate when validationRules is a string', () => {
                ...
                const ret = requestValidator.Validate('Ms. Frizzle', 'string');
            ...
            it('should load validationRules from a file and successfully validate when validationRules is a validation object', () => {
                ...
                const ret = requestValidator.Validate('Ms. Frizzle', '../../test/_mockData/validationRules.mock.json');
            ...
            it('should return a failure when validationRules is a validation object', () => {
                ...
                const ret = requestValidator.Validate('Ms. ', '../../test/_mockData/validationRules.mock.json');
        ...
        describe('ValidateVar Test', () => {
            ...
            it('Should throw when regexp is not a regexp', () => {
                try {
                    requestValidator.ValidateVar('Ms. Frizzle', 'string', { regexp: '^Ms. |^Mrs. ' });
                    sinon.assert.fail('Function did not throw');
                } catch (e) {
            ...
            it('should successfully validate an email', () => {
                ...
                const resp = requestValidator.ValidateVar('valerie.frizzel@example.com', 'email', {});
            ...
            it('should return invalid when string is not in valid email format', () => {
                ...
                const resp = requestValidator.ValidateVar('valerie.frizzelexample.com', 'email', {});

                resp.should.deep.equal({
                    valid: false,
                    details: `string "valerie.frizzelexample.com" is not in valid email format`,
                });
                isNullStub.calledOnce.should.be.true;
            });
            ...
            it('should return invalid when email is not a string', () => {
                ...
                const resp = requestValidator.ValidateVar({ email: 'valerie.frizzel@example.com' }, 'email', {});
            ...
            it('should successfully validate a string', () => {
                ...
                const resp = requestValidator.ValidateVar('Ms. Frizzle', 'string', {});
            ...
            it('should return invalid when string does not mach the regexp', () => {
                ...
                const resp = requestValidator.ValidateVar('Mr. Frizzle', 'string', { regexp: /^Ms. |^Mrs. / });

                resp.should.deep.equal({
                    valid: false,
                    details: `string 'Mr. Frizzle' does not match regex [/^Ms. |^Mrs. /]`,
                });
                isNullStub.calledOnce.should.be.true;
            });
